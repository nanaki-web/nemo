 ...
 */
final class Version20220921095621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, commercial_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, numero VARCHAR(50) NOT NULL, adress VARCHAR(50) NOT NULL, code_postal VARCHAR(50) NOT NULL, ville VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, type VARCHAR(50) NOT NULL, coefficient VARCHAR(50) NOT NULL, siret VARCHAR(15) DEFAULT NULL, UNIQUE INDEX UNIQ_C7440455E7927C74 (email), INDEX IDX_C74404557854071C (commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commercial (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, UNIQUE INDEX UNIQ_7653F3AEE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT NOT NULL, nom VARCHAR(50) NOT NULL, description VARCHAR(100) NOT NULL, prix NUMERIC(10, 2) NOT NULL, active TINYINT(1) NOT NULL, stock INT NOT NULL, coef NUMERIC(10, 2) NOT NULL, reference VARCHAR(50) NOT NULL, photo VARCHAR(50) DEFAULT NULL, INDEX IDX_29A5EC27670C757F (fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ss_rubrique (id INT AUTO_INCREMENT NOT NULL, ss_rubrique_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_5654E3375E3003B1 (ss_rubrique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
